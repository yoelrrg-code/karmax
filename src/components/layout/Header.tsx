...
export const Header: React.FC<FooterProps> = ({data}) => {
  ...
  return (
    <header className={`sticky top-0 z-50 bg-white transition-all duration-300 ease-in-out ${isScrolled ? "h-18 md:h-20 shadow-2xs" : "h-22 md:h-30"}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full relative z-50 bg-white">
        <div className="flex items-center justify-between h-full">
          ...
          <nav className="hidden min-[992px]:flex items-center space-x-8 text-sm font-medium text-[var(--blue-karmax)] ml-auto mr-10">
            <Link
              href="/productos"
          ...
          <div className="flex items-center space-x-2 sm:space-x-4">
            ...
            <a
              ...
              className="hidden min-[992px]:inline-flex group items-center gap-2 bg-[var(--green-karmax)] hover:bg-[var(--green-hover-karmax)] text-white px-5 py-2 rounded-full text-[16px] font-medium shadow-xs hover:shadow-md transition-all duration-300 active:scale-95 cursor-pointer"
            >
              <Icon
                name="whatsapp"
                size={24}
            ...
            {/* Cart / Quote Bag & Popover - Always visible */}
            <div className="relative">
              <button
                type="button"
                onClick={openDrawer}
            ...
            {/* Mobile Menu Toggle Button (< 992px) */}
            <button
              type="button"
              onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)}
              className="flex min-[992px]:hidden items-center justify-center h-10 w-10 p-2 text-slate-700 hover:text-[var(--blue-karmax)] hover:bg-[var(--light-bg-karmax)] rounded-full transition-all duration-200 active:scale-95 cursor-pointer"
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            ...
            className="min-[992px]:hidden fixed inset-0 z-40 bg-white flex flex-col justify-between px-6 pt-24 md:pt-28 pb-10 overflow-y-auto"
          >
            <div className="space-y-6 pt-4">
              ...
              >
                <Link
                  ...
                  className="block py-2 text-[24px] font-medium text-[var(--blue-karmax)] hover:text-[var(--green-karmax)] transition-colors"
                >
                  Productos
                </Link>
              </motion.div>
              ...
              >
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group flex items-center justify-center gap-2 w-fit bg-[var(--green-karmax)] hover:bg-[var(--green-hover-karmax)] text-white py-3 px-4 rounded-full font-medium shadow-xs transition-all duration-300 active:scale-95 cursor-pointer"
                >
                  <Icon
                    name="whatsapp"
                    size={24}
